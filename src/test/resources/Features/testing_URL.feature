...
@PCC_Verify_individual_Article_page.RNL
...
@PCC_Verify_All_Article_design_and_Pagenation.RNL
Scenario Outline: Verify Individual Article Page
Given Open site in "<browser>"  
Then navigate to the site
Then verify the home page title
...
@PCC_Verify_All_Article_Pagenation.RNL
Scenario Outline: Verify Individual Article Page
Given Open site in "<browser>"  
Then navigate to the site
Then verify the home page title
...
@PCC_verify_Subscribe_Article_page.RNL
...
@PCC_verify_Subscribe_Article_page_linkdn_login.RNL
...
@PCC_Validate_Subscribe_Preference.RNL
...
Scenario Outline: Verify the Preference link(TC ID-64)
	...
	Examples: 
		|browser	|
		|chrome		|
@Business_Preferences_Saving.RNL
...
|browser	|
|chrome		|
@clear_All_Button_All_Article_Page.RNL
...
Examples: 
		|browser	|
		|chrome		|		
@clear_All_Button_On_Pop_Up.RNL
...
Examples: 
		|browser	|
		|chrome		|
@Dropdowns_Selection.RNL
@Business_location_Saving.RNL
...
Examples: 
		|browser	|
		|chrome		|
@Preference_Page_Validations.RNL
