...
public class Article_Page_Validations extends Baseclass {
	...
	public void Click_View_All_Article_Button() {
		try {
			...
			// By.xpath(elementProperties.getProperty("All_Article_Button"))).click();
			Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Latest_View_All_Articles")))
					.click();
	...
	public void Verify_Page_Title_Text() {
		try {
			String Header_Text = Baseclass
					.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("All_Article_Header_Title")))
					.getText().trim();
			System.out.println("Header_Text " + Header_Text);
			String Header_Description = Baseclass
					.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("All_Article_Desc"))).getText()
					.trim();
			System.out.println("Header_Description " + Header_Description);
			if (((Header_Text.trim()).equals(elementProperties.getProperty("All_Articles_Header_Text")))
					&& ((Header_Description.trim())
							.equals(elementProperties.getProperty("All_Articles_Header_Desc")))) {
	...
	public void verify_Pagenation() {
		try {
			...
			if (Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Page_Nation_Next")))
					.isEnabled()) {
				test.log(LogStatus.PASS, "Able to Click Next Button");
			} else {
				test.log(LogStatus.FAIL, "Unable to Click Next Button");
			}
			if (Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Page_Nation_Previous")))
					.isEnabled()) {
			...
			try {
				if (Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Page_Nation_1")))
						.isEnabled()) {
				...
				if (Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Page_Nation_1_Catch")))
						.isEnabled()) {
					test.log(LogStatus.PASS, "1 option is getting highlighted ");
				} else {
			...
			if (Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Page_Nation_2")))
					.isEnabled()) {
				test.log(LogStatus.PASS, "Able to Click 2nd Page");
			} else {
				test.log(LogStatus.FAIL, "Unable to Click 2nd Page");
			}
			if (Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Page_Nation_3")))
					.isEnabled()) {
				test.log(LogStatus.PASS, "Able to Click 3rd Page");
			} else {
				test.log(LogStatus.FAIL, "Unable to Click 2rd Page");
			}
			if (Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Page_Nation_dots")))
					.isEnabled()) {
			...
			if (Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Page_Nation_Last")))
					.isEnabled()) {
			...
			try {
				...
				if (Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Page_Nation_2_Catch")))
						.isEnabled()) {
					test.log(LogStatus.PASS, "2 option is getting highlighted in Page 2 ");
				} else {
	...
	public void Verify_Filter_option() {
		try {
			Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Filter_Option_All_Articles")))
					.click();
	...
	public void Image_after_login() throws InterruptedException, IOException {
		try {
			...
			String Image = Baseclass
					.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Login_Image_after_login")))
					.getAttribute("src");
	...
	public void Toolkit_cards() throws InterruptedException {
		try {
			...
			String Colour1 = Baseclass
					.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Hover_Pre_Start_up")))
			...
			String Article_name = Baseclass
					.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("First_card_text"))).getText();
			Baseclass.explicitlyWait(5);
			Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Hover_Pre_Start_up"))).click();
			String Article_name_afterclick = Baseclass
					.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("First_card_text"))).getText();
			if (Article_name.equalsIgnoreCase(Article_name_afterclick)) {
				...
				Article_name = Baseclass
						.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("First_card_text")))
						.getText();
			}
			Baseclass.explicitlyWait(5);
			Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Hover_Start_up"))).click();
			Article_name_afterclick = Baseclass
					.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("First_card_text"))).getText();
			if (Article_name.equalsIgnoreCase(Article_name_afterclick)) {
	...
	public void Toolkit_article() throws InterruptedException {
		try {
			if (browser.equalsIgnoreCase("Mobile")) {
				Baseclass
						.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Toolkits_Mobile_dropdown")))
						.click();
				Baseclass.explicitlyWait(2);
				Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Mobile_Menu_Pre_startup")))
						.click();
				Baseclass.explicitlyWait(2);
				Baseclass.scrollDownFull();
			} else {
			...
			if (Toolkit.startsWith("toolkits")) {
				test.log(LogStatus.PASS,
						"Clicked Pre Start up button and selected first card in the page. Site is re-directed to toolkit's article page");
			} else {
				test.log(LogStatus.FAIL,
						"Clicked Pre Start up button and selected first card in the page. Site is not getting re-directed to toolkit's article page");
			}
	...
	public void Click_Required_Article() throws InterruptedException {
		try {
			...
			Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Cyber_Security_Bussiness")))
					.click();
			Baseclass.explicitlyWait(4);
			for (int k = 1; k <= 8; k++) {
				try {
					String Tag_Atricle = Baseclass.WaitElementVisible(driver,
							By.xpath("//*[@id=\"page-wrapper\"]/main/div[3]/div[1]/div[2]/div/div/div/div[" + k
									+ "]/article/a/div[2]/div[2]/div"))
							.getText();
	...
	public void Click_Subscribe_Button() throws InterruptedException {
		try {
			...
			try {
				String Subscribe_Color = Baseclass
						.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Hover_Subscribe")))
						.getCssValue("color");
				...
				Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Hover_Subscribe")))
						.click();
				Baseclass.explicitlyWait(5);
				String Subscribed = Baseclass
						.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Subscribe_after_Click")))
						.getText();
				...
				if (Subscribed.equals("SUBSCRIBED")) {
					...
					test.log(LogStatus.FAIL,
							"Subscribe button is not changed to 'Subscribed' upon clicking on the button");
				}
			} catch (TimeoutException e) {
				String Subscribed = Baseclass
						.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Subscribe_after_Click")))
			...
			// Baseclass.WaitElementVisible(driver,
			// By.xpath(elementProperties.getProperty("Header_Logo"))).click();
		} catch (StaleElementReferenceException | ElementNotInteractableException e) {
			test.log(LogStatus.FAIL, "Unable to automate next button due to exception");
			e.printStackTrace();
		}
	...
	public void Click_Subscribe_Button_Article_Page() throws InterruptedException {
		try {
			...
			String Title = Baseclass
					.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Subscribe_Popup_Title")))
					.getText();
			String Para = Baseclass
					.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Subscribe_Popup_Para")))
					.getText();
			System.out.println("Title :" + Title);
			...
			Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Article_Linkden_Poup")))
					.click();
			Baseclass.explicitlyWait(3);
			Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Linkden_Poup"))).click();
	...
	public void Verify_Subscribed() throws InterruptedException {
		...
		try {
			for (int j = Subscribe_article + 1; j <= 8; j++) {
				try {
					String Tag_Atricle = Baseclass.WaitElementVisible(driver,
							By.xpath("//*[@id=\"page-wrapper\"]/main/div[3]/div[1]/div[2]/div/div/div/div[" + j
									+ "]/article/a/div[2]/div[2]/div"))
							.getText();
			...
			try {
				...
				if (Subscribed.equals("SUBSCRIBED")) {
					test.log(LogStatus.PASS,
							"Subscribe button is changed to 'Subscribed' for remaining articles of same category");
					try {
						Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Subscribe_Tick")));
					...
					test.log(LogStatus.FAIL,
							"Subscribe button is not changed to 'Subscribed' for remaining articles of same category");
				}
			} catch (TimeoutException e) {
				test.log(LogStatus.FAIL,
						"Subscribe button is not changed to 'Subscribed' for remaining articles of same category");
	...
	public void Check_Preferences_saved() throws InterruptedException {
		try {
			...
			Baseclass.explicitlyWait(4);
			Baseclass.scrollDown();
			String Preference = Baseclass
					.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Save_Preference")))
					.getAttribute("class");
			...
			try {
				...
				Baseclass.explicitlyWait(2);
				Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Save_Preference_toggle")))
						.click();
				Baseclass.explicitlyWait(2);
				Baseclass.scrollDownFull();
	...
	public void Video_option_article() {
		try {
			...
			for (int i = 2; i < article_count; i++) {
				try {
					driver.findElement(By.xpath("//*[@id=\"page-wrapper\"]/main/div/div[1]/div/div/div/div[" + i
							+ "]/article/a/div[1]/div/div[2]"));
					driver.findElement(
							By.xpath("//*[@id=\"page-wrapper\"]/main/div/div[1]/div/div/div/div[" + i + "]/article/a"))
							.click();
					Baseclass.explicitlyWait(5);
					try {
						String youtube_Link = Baseclass
								.WaitElementVisible(driver,
										By.xpath(elementProperties.getProperty("Youtube_Video_Icon")))
								.getAttribute("style");
						...
						try {
							String Article_Link = Baseclass
									.WaitElementVisible(driver,
											By.xpath(elementProperties.getProperty("Video_Article")))
									.getAttribute("poster");
							System.out.println("Article_Link : " + Article_Link);
							test.log(LogStatus.PASS, "Video Icon is populating for video articles as expected");
						} catch (TimeoutException e1) {
							try {
								String Article_Link_tag = Baseclass.WaitElementVisible(driver, By.tagName("video"))
										.getAttribute("poster");
					...
					if (article_count - 1 == i - 1) {
						Baseclass
								.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Page_Nation_Last")))
								.click();
						Baseclass.explicitlyWait(5);
		...
		try {
			...
			try {
				...
				Article_Title = Baseclass
						.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Article_Title"))).getText();
				Last_Updated = Baseclass
						.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Article_date"))).getText();
				Share_field = Baseclass
						.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Share_field"))).getText();
				System.out.println("Last_Updated: " + Last_Updated);
			} catch (TimeoutException e) {
				System.out.println("Catch");
				Article_Title = Baseclass
						.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Article_Title_Double")))
						.getText();
				Last_Updated = Baseclass
						.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Article_date_Double")))
						.getText();
				Share_field = Baseclass
						.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Share_field_Double")))
						.getText();
				System.out.println("Last_Updated: " + Last_Updated);
			}
			int Title_size = 0;
	...
	public void Verify_fields_bottom_page() {
		try {
			String More_Topics = Baseclass
					.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("More_Topics_Articles")))
					.getText();
			String Also_like = Baseclass
					.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("You_might_Also_Like")))
					.getText();
			if (More_Topics.equalsIgnoreCase(elementProperties.getProperty("More_Topics_Actual"))) {
				test.log(LogStatus.PASS,
						"'More topics to interest you' field is populating fine in the bottom of article page");
				if (Also_like.equalsIgnoreCase(elementProperties.getProperty("Also_like_Actual"))) {
					test.log(LogStatus.PASS,
							"'You might also like' field is populating fine in the bottom of article page");
				} else {
					test.log(LogStatus.FAIL,
							"'You might also like' field is not populating fine in the bottom of article page");
				}
			} else {
				test.log(LogStatus.FAIL,
						"'More topics to interest you' field is not populating fine in the bottom of article page");
			}
	...
	public static void Verify_Events_Article_Page() throws IOException {
		try {
			...
			try {
				HttpClient client = HttpClientBuilder.create().build();
				String Image = Baseclass
						.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("No_Events")))
						.getAttribute("src");
				...
				String Title_No_result = Baseclass
						.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("No_Events_Text_Title")))
						.getText();
				String Desc_No_result = Baseclass
						.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("No_Events_Text_Desc")))
						.getText();
				if ((Title_No_result.equalsIgnoreCase("Sorry, there are no events on at the moment."))
						&& (Desc_No_result.equals("Check back again soon to see what's going on in your area."))) {
					test.log(LogStatus.PASS,
							"No results Title and Description in the Event article are populating fine if no results found");
				} else {
					test.log(LogStatus.FAIL,
							"No results Title and Description in the Event article are not 	populating fine if no results found");
				}
			} catch (NoSuchElementException | TimeoutException e) {
				Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("First_Event"))).click();
				Baseclass.explicitlyWait(5);
				String Title = Baseclass
						.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Event_Title"))).getText();
				if (Title.length() == 0) {
					test.log(LogStatus.FAIL,
							"Title in the Event article is not populating fine for the Event : " + Title);
				} else {
					test.log(LogStatus.PASS, "Title in the Event article is populating fine for the Event : " + Title);
					String Subtitle = Baseclass
							.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Event_SubTitle")))
							.getText();
					try {
						if (Subtitle.length() == 0) {
							test.log(LogStatus.FAIL,
									"Sub-Title in the Event article is not populating fine for the Event : " + Title);
						} else {
							test.log(LogStatus.PASS,
									"Sub-Title in the Event article is populating fine for the Event : " + Title);
							Baseclass.scrollDown();
							HttpClient client = HttpClientBuilder.create().build();
							String Image = Baseclass
									.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Events_Image")))
									.getAttribute("src");
							System.out.println("Image " + Image);
							HttpGet request = new HttpGet(Image);
							HttpResponse response = client.execute(request);
						...
						test.log(LogStatus.FAIL,
								"Sub-Title/Image in the Event article is not populating fine for the Event : " + Title);
					}
	...
	public void Change_Preferences() throws InterruptedException {
		try {
			...
			Baseclass.scrollDown();
			String Preference = Baseclass
					.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Change_Preference")))
					.getAttribute("class");
			System.out.println("Preference : " + Preference);
			String[] Url = Preference.split("c");
			try {
	...
	public void Verify_Subscribed_Market_Trends() throws InterruptedException {
		try {
			...
			Baseclass.explicitlyWait(4);
			Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Market_Economics_Weekly")))
					.click();
			Baseclass.explicitlyWait(4);
			System.out.println("Preference_article" + Preference_article);
			if (Preference_article == 0) {
				String Subscribed = Baseclass
						.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Subscribe_Preference")))
						.getText();
				if (Subscribed.equals("SUBSCRIBED")) {
					test.log(LogStatus.PASS,
							"Subscribe button is changed to 'Subscribed' for remaining articles of same category");
					try {
						Baseclass.WaitElementVisible(driver,
								By.xpath(elementProperties.getProperty("Preference_Subscribe_Tick")));
				...
				String Subscribed = Baseclass.WaitElementVisible(driver,
						By.xpath(elementProperties.getProperty("Subscribe_Preference_button"))).getText();
				if (Subscribed.equals("SUBSCRIBE")) {
					test.log(LogStatus.PASS,
							"Subscribed button is changed to 'Subscribe' if changed in the preference page");
				} else {
					test.log(LogStatus.FAIL,
							"Subscribed button is not changed to 'Subscribe' if changed in the preference page");
				}
			}
		} catch (StaleElementReferenceException | ElementNotInteractableException e) {
	...
	public void Verify_Header_Title_Text() throws InterruptedException {
		try {
			String All_Article_Title = Baseclass
					.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("All_Articles_Title")))
					.getText();
			...
			String All_Article_Text = Baseclass
					.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("All_Articles_Text"))).getText();
	...
	public void Verify_articles_Pagenation() throws InterruptedException {
		try {
			String Last_Page_Number = Baseclass
					.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("All_Articles_Pagenation")))
					.getText();
			...
			if (Last_Number > 1) {
				...
				if (Card_Number == 40) {
					test.log(LogStatus.PASS,
							"Pages number one is populating 40 cards if there is more than one page in the pagenation in All Article page");
				} else {
					test.log(LogStatus.FAIL,
							"Pages number one is not populating 40 cards if there is more than one page in the pagenation in All Article page");
				}
				for (int i = 1; i <= Card_Number; i++) {
					String Title = driver
							.findElement(By.xpath("//*[@id=\"page-wrapper\"]/main/div/div[1]/div/div/div/div[" + i
									+ "]/article/a/div[2]/div/p"))
							.getText();
					if (Title.length() > 1) {
						test.log(LogStatus.PASS,
								"Title of the card " + i + " is populated fine in the All Articles page");
					} else {
						test.log(LogStatus.FAIL,
								"Title of the card " + i + " is not populated fine in the All Articles page");
					}
				}
				Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("All_Articles_Pagenation")))
						.click();
				Baseclass.scrollDownFull();
				Baseclass.explicitlyWait(3);
