...
public class NavigateToSite extends Baseclass {
	...
	public void Accept_the_cookies() {
		...
		try {
			...
			case "RBS Premier":
				...
				// By.xpath(elementProperties.getProperty("acceptcookies"))).click();
			case "Ulster NI":
			case "UIster ROI":
			case "Ulster ROI":
	...
	public void Verify_RBS_Logo() throws IOException {
		try {
			...
			String Hearder_Image = Baseclass
					.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Header_Logo")))
					.getAttribute("src");
			Baseclass.scrollDownFull();
			String Footer_Image = Baseclass
					.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Header_Logo")))
					.getAttribute("src");
			...
			WebElement Click_Bussiness = Baseclass.WaitElementVisible(driver,
			...
			test.log(LogStatus.PASS,
					"Header and Footer logo is loading fine upon re-directing to other pages other than Home page");
	...
	public void Verify_the_Followon_links_Linkedin_Twitter() {
		try {
			...
			if (browser != null) {
				Baseclass.explicitlyWait(Baseclass.timeout);
				Baseclass.scrollDownFull();
				String Twitter = Baseclass
						.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("footertwitter")))
						.getAttribute("href");
				Baseclass.explicitlyWait(Baseclass.timeout);
				...
				String Linkden = Baseclass
						.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("footerlinkedin")))
						.getAttribute("href");
	...
	public void Verify_the_Footer_links_Accessibility_Privacy_Terms_and_Conditions() {
		try {
			Baseclass.scrollDownFull();
			WebElement accessibility = Baseclass.WaitElementVisible(driver,
					By.xpath(elementProperties.getProperty("accessibility1")));
			Baseclass.JavaScriptExec_click(accessibility);
			// Baseclass.WaitElementVisible(driver,
			// By.xpath(elementProperties.getProperty("accessibility1"))).click();
			driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
			String pageHeader = Baseclass
					.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("accessibilitypageheader")))
					.getText();
			...
			Baseclass.scrollDownFull();
			driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
			WebElement privacypageheader = Baseclass.WaitElementVisible(driver,
					By.xpath(elementProperties.getProperty("privacy")));
			Baseclass.JavaScriptExec_click(privacypageheader);
			// Baseclass.WaitElementVisible(driver,
			// By.xpath(elementProperties.getProperty("privacy"))).click();
			driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
			String privacy = Baseclass
					.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("privacypageheader"))).getText();
		...
		try {
			...
			if (Menuname.equalsIgnoreCase("Toolkits")) {
				...
				if ((Baseclass.get_Url()).equalsIgnoreCase(Actual_Current_Url)) {
					...
					test.log(LogStatus.PASS, "Url is populating fine with the tag /" + (Baseclass.get_Url())
							+ " for the page " + (elementProperties.getProperty("Actual_Tookits")));
					...
					test.log(LogStatus.FAIL, "Url is not populating with the tag /" + (Baseclass.get_Url())
							+ " for the page " + (elementProperties.getProperty("Actual_Tookits")));

				}
				int forms = Baseclass.get_Count(elementProperties.getProperty("Toolkits_count"));
				for (i = 1; i <= forms; i++) {
					// String business_guidance_loop= Baseclass.WaitElementVisible(driver,
					// By.xpath(elementProperties.getProperty("business_guidance_text_loop"))).getText();
					if (browser.contentEquals("Mobile")) {
						if (i > 2) {
							WebElement webElement = driver.findElement(
									By.xpath("//*[@id=\"page-wrapper\"]/main/section/div/div/div/div[3]/div/div["
											+ (i - 1) + "]/article/a"));
							webElement.sendKeys(Keys.TAB);
						}
					}
					String business_guidance_loop = driver
							.findElement(By.xpath("//*[@id=\"page-wrapper\"]/main/section/div/div/div/div[3]/div/div["
									+ i + "]/article/a/div[2]/p[2]"))
							.getText();
					if (business_guidance_loop.equals(elementProperties.getProperty("Actual_Tookits"))) {
						...
						if (i == 5) {
							...
							System.out.println("i=" + i);
							WebElement scrolldown = driver.findElement(
									By.xpath("//*[@id=\"page-wrapper\"]/main/section/div/div/div/div[3]/div/div["
											+ (i + 4) + "]/article/a/div[2]/p[2]"));
							...
							WebElement scrolldown = driver.findElement(
									By.xpath("//*[@id=\"page-wrapper\"]/main/section/div/div/div/div[3]/div/div["
											+ (i + 1) + "]/article/a/div[2]/p[2]"));
							Actions actions = new Actions(driver);
							actions.moveToElement(scrolldown).perform();
							Baseclass.explicitlyWait(2);
						}
						String Image = driver.findElement(
								By.xpath("//*[@id=\"page-wrapper\"]/main/section/div/div/div/div[3]/div/div[" + i
										+ "]/article/a/div[1]/div/div/div/img[2]"))
								.getAttribute("src");
						HttpGet request = new HttpGet(Image);
						HttpResponse response = client.execute(request);
						System.out.println("Code : " + response.getCode());
				...
				String business_guidance = Baseclass
						.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Events_Text"))).getText();
	...
	public void Validate_Menu_Options(String MenuType) throws IOException, AWTException {
		try {
			...
			case "Business Guidence":
				...
				Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("business_guidance")))
						.click();
				System.out.println("Bussiness");
			...
			if ((Baseclass.get_Url()).equalsIgnoreCase(Actual_Current_Url)) {
				...
				test.log(LogStatus.FAIL, "Url is not populating fine with the tag /" + (Baseclass.get_Url())
						+ " for the page " + Title_Text);
			}
				...
				if (browser.contentEquals("Mobile")) {
					if (i > 9) {
						WebElement webElement = driver.findElement(By.xpath(
								"//*[@id=\"page-wrapper\"]/main/div/div/div/div/div[" + (i - 1) + "]/article/a"));
						webElement.sendKeys(Keys.TAB);
					}
				}
				String business_guidance_loop = driver
						.findElement(By.xpath(
								"//*[@id=\"page-wrapper\"]/main/div/div/div/div/div[" + i + "]/article/a/div[2]/p[2]"))
						.getText();
	...
	public static void Navigate_Article() {
		try {
			...
			Baseclass.explicitlyWait(Baseclass.timeout);
			Article_Title = Baseclass
					.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Article_Text"))).getText();
	...
	public void Verify_Facebook_Share() {
		try {
			...
			Baseclass.explicitlyWait(Baseclass.timeout);
			Baseclass.switchToNewWindow();
			Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Facebook_user")))
					.sendKeys(elementProperties.getProperty("Facebook_Username"));
			Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Facebook_Pass")))
					.sendKeys(elementProperties.getProperty("Facebook_Password"));
		...
		try {
			...
			if (Text.equalsIgnoreCase(Article_Title)) {
				...
				if (SecondPost.equalsIgnoreCase(Article_Title)) {
					test.log(LogStatus.PASS,
							"Logged into Facebook and checked the Post is shared on the facebook wall");
				} else {
	...
	public void Verify_Twitter_Share() {
		try {
			...
			Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Twitter_user")))
					.sendKeys(elementProperties.getProperty("Twitter_Username"));
			Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Twitter_Pass")))
					.sendKeys(elementProperties.getProperty("Twitter_Password"));
			Baseclass.explicitlyWait(Baseclass.timeout);
			Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Twitter_Login_Main"))).click();
			try {
				String Error = Baseclass
						.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Twitter_login_error")))
						.getText();
				...
				Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Twitter_Text")))
						.sendKeys(Article_Title);
				Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Twitter_Pop_share")))
						.click();
	...
	public void Check_post_Twitter() {
		try {
			...
			Baseclass.windowmaximize();
			String Text = null;
			Text = Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Twitter_Shared_Post")))
					.getText().trim();
			System.out.println("Text " + Text);
			if (Text.equalsIgnoreCase(Article_Title)) {
				...
				String SecondPost = Baseclass
						.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Twitter_second_Post")))
						.getText();
				System.out.println("SecondPost " + SecondPost);
				if (SecondPost.equalsIgnoreCase(Article_Title)) {
					test.log(LogStatus.PASS, "Logged into Twitter and checked the Post is shared on the Twitter wall");
	...
	public void Verify_Linkden_Share() {
		try {
			Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Linkden_Article_Share")))
					.click();
			Baseclass.switchToNewWindow();
			Baseclass.explicitlyWait(Baseclass.timeout);
			...
			Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Linkden_Post_Text")))
					.sendKeys(Article_Title);
			driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
			Baseclass.scrollDownFull();
	...
	public static void Check_Linkden_post() throws AWTException {
		try {
			...
			String Now = Baseclass
					.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Linkden_view_share")))
					.getText();
			System.out.println("Now: " + Now);
			if (Now.contains("now •")) {
				Baseclass.explicitlyWait(Baseclass.timeout);
				String Verify_Linkden = Baseclass
						.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Verify_linkden")))
						.getText();
	...
	public static void Validate_Search_Icon() {
		try {
			...
			Actions builder = new Actions(driver);
			builder.click(Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Search_icon"))))
					.perform();
			Baseclass.explicitlyWait(Baseclass.timeout);
			Object obj_After_Click = jse
					.executeScript("return document.getElementsByTagName('form')[0].getAttribute('class')");
			String Search_icon_After_Click = (String) obj_After_Click;
			if (Search_icon_After_Click.startsWith("j")) {
				test.log(LogStatus.FAIL,
						"Search icon is getting displayed without any search bar after clicked on search icon");
			} else {
				test.log(LogStatus.PASS,
						"Search icon is getting displayed with search bar after clicked on search icon");
			}
	...
	public static void search_any_text() {
		try {
			...
			String Result_Text = Baseclass
					.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Result_Text"))).getText();
			System.out.println("Search_Text " + Result_Text);
			if (Result_Text.contains(elementProperties.getProperty("Result_text"))) {
				test.log(LogStatus.PASS,
						"Results text is popualting fine. Number of results populated are " + Result_Text);
			} else {
				test.log(LogStatus.FAIL, "Results text is not popualting.");
			}
			String[] Total_results = Result_Text.split(" ");
			Total_Number = Total_results[0];
			String Articles_highlight = Baseclass
					.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Articles_Number")))
	...
	public static void Validate_Results() {
		try {
			...
			if (Baseclass.browser != null) {
				...
				String Articles_Field = Baseclass
						.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Articles_Number")))
						.getText().trim();
				driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
				...
				String Spotlight_Field = Baseclass
						.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Spotlight_Number")))
						.getText().trim();
				...
				String Toolkit_Field = Baseclass
						.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Toolkit_Number"))).getText()
						.trim();
				...
				String Events_Field = Baseclass
						.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Event_Number"))).getText()
						.trim();
				...
				if ((Articles_Number + Spotlight_Number + Toolkit_Number + Events_Number) == Total) {
					test.log(LogStatus.PASS,
							"Total Results is getting matched with Sum of all Search results tabs results. Total = "
									+ Total + " where Sum = "
									+ (Articles_Number + Spotlight_Number + Toolkit_Number + Events_Number));
				} else {
					test.log(LogStatus.FAIL,
							"Total Results is not getting matched with Sum of all Search results tabs results. Total = "
									+ Total + " where Sum = "
									+ (Articles_Number + Spotlight_Number + Toolkit_Number + Events_Number));
				}
	...
	public static int Very_Count_Sub_Tasks(String Search_Result_count, String Search_Page_Last) {
		try {
			try {
				String Search_Page_Last_Number = "//*[@id=\"results-tabpanel-" + Sub_Tab
				...
				String PageNation = driver
						.findElement(By.xpath("//*[@id=\"results-tabpanel-" + Sub_Tab
								+ "\"]/div/div/div[2]/div/div/button[" + (get_Last_page_Number - 1) + "]"))
						.getText().trim();
				int Page_count = Integer.parseInt(PageNation);
				Page_count = Page_count - 1;
				Page_count = Page_count * get_count;
				driver.findElement(By.xpath("//*[@id=\"results-tabpanel-" + Sub_Tab
						+ "\"]/div/div/div[2]/div/div/button[" + (get_Last_page_Number - 1) + "]")).click();
				Baseclass.explicitlyWait(Baseclass.timeout);
	...
	public static void Verify_Zero_Results(String Image, String Text) throws IOException {
		try {
			...
			if (response.getCode() == 200) {
				test.log(LogStatus.PASS,
						"No results image is populating fine in the Articles Tab for the searched text : "
								+ (elementProperties.getProperty("Search_text")));
			} else {
				test.log(LogStatus.FAIL,
						"No results image is not populating fine in the Articles Tab for the searched text : "
								+ (elementProperties.getProperty("Search_text")));
			}
	...
	public static void Click_Article_and_Validate(String Search_Result_count, String Search_Page_Last)
			throws IOException {
		try {
			...
			if (Articles_Number != 0) {
				...
				if (Articles_Number == Sub_Count_Article) {
					test.log(LogStatus.PASS,
							"Count coming in the Article Field is getting matched with the results populating for the searched text :"
									+ (elementProperties.getProperty("Search_text")));
				} else {
					test.log(LogStatus.FAIL,
							"Count coming in the Article Field is not getting matched with the results populating for the searched text :"
									+ (elementProperties.getProperty("Search_text")));
				}
			} else if (Articles_Number == 0) {
				test.log(LogStatus.PASS, "Article Count is populating '0' for the searched text :"
						+ (elementProperties.getProperty("Search_text")));
				String Image = Baseclass
						.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("No_Results_Image_Article")))
						.getAttribute("src");
				String Text = Baseclass
						.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("No_Results_Text_Article")))
						.getText();
				System.out.println("Text : " + Text);
	...
	public static void Click_SpotLight_and_Validate(String Search_Result_count, String Search_Page_Last)
			throws IOException {
		try {
			Sub_Tab = 1;
			...
			if (Spotlight_Number != 0) {
				...
				if (Spotlight_Number == Sub_Count) {
					test.log(LogStatus.PASS,
							"Count coming in the SpotLight Field is getting matched with the results populating for the searched text :"
									+ (elementProperties.getProperty("Search_text")));
				} else {
					test.log(LogStatus.FAIL,
							"Count coming in the SpotLight Field is not getting matched with the results populating for the searched text :"
									+ (elementProperties.getProperty("Search_text")));
				}
			} else if (Spotlight_Number == 0) {
				test.log(LogStatus.PASS, "SpotLight Count is populating '0' for the searched text :"
						+ (elementProperties.getProperty("Search_text")));
				String Image = Baseclass
						.WaitElementVisible(driver,
								By.xpath(elementProperties.getProperty("No_Results_Image_Spotlight")))
						.getAttribute("src");
				String Text = Baseclass.WaitElementVisible(driver,
						By.xpath(elementProperties.getProperty("No_Results_Text_Spotlight"))).getText();
				NavigateToSite.Verify_Zero_Results(Image, Text);
			}
	...
	public static void Click_Toolkits_and_Validate(String Search_Result_count, String Search_Page_Last)
			throws IOException {
		try {
			Sub_Tab = 2;
			...
			if (Toolkit_Number != 0) {
				...
				if (Toolkit_Number == Sub_Count) {
					test.log(LogStatus.PASS,
							"Count coming in the Toolkits Field is getting matched with the results populating for the searched text :"
									+ (elementProperties.getProperty("Search_text")));
				} else {
					test.log(LogStatus.FAIL,
							"Count coming in the Toolkits Field not is getting matched with the results populating for the searched text :"
									+ (elementProperties.getProperty("Search_text")));
				}
			} else if (Toolkit_Number == 0) {
				test.log(LogStatus.PASS, "Toolkits Count is populating '0' for the searched text :"
						+ (elementProperties.getProperty("Search_text")));
				String Image = Baseclass
						.WaitElementVisible(driver,
								By.xpath(elementProperties.getProperty("No_Results_Image_Toolkits")))
						.getAttribute("src");
				String Text = Baseclass
						.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("No_Results_Text_Toolkits")))
						.getText();
				NavigateToSite.Verify_Zero_Results(Image, Text);
			}
	...
	public static void Click_Events_and_Validate(String Search_Result_count, String Search_Page_Last)
			throws IOException {
		try {
			Sub_Tab = 3;
			...
			if (Events_Number != 0) {
				...
				if (Events_Number == Sub_Count) {
					test.log(LogStatus.PASS,
							"Count coming in the Events Field is getting matched with the results populating for the searched text :"
									+ (elementProperties.getProperty("Search_text")));
				} else {
					test.log(LogStatus.FAIL,
							"Count coming in the Events Field is not getting matched with the results populating for the searched text :"
									+ (elementProperties.getProperty("Search_text")));
				}
			} else if (Events_Number == 0) {
				test.log(LogStatus.PASS, "Events Count is populating '0' for the searched text :"
						+ (elementProperties.getProperty("Search_text")));
				String Image = Baseclass
						.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("No_Results_Image_Events")))
						.getAttribute("src");
				String Text = Baseclass
						.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("No_Results_Text_Events")))
						.getText();
				NavigateToSite.Verify_Zero_Results(Image, Text);
			}
	...
	public static void Validate_Latest_Articles_title_home_page(String Field_Title, String Actual_Field_Title) {
		try {
			String Latest_Title = Baseclass
					.WaitElementVisible(driver, By.xpath(elementProperties.getProperty(Field_Title))).getText().trim();
	...
	public static void Latest_Articles_View_all() {
		try {
			Baseclass.explicitlyWait(Baseclass.timeout);
			if (Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Latest_View_All")))
					.isDisplayed()) {
				Baseclass.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("Latest_View_All")))
						.click();
				Baseclass.explicitlyWait(Baseclass.timeout);
				if ((Baseclass.get_Url()).equals(elementProperties.getProperty("Current_URL_articles"))) {
					test.log(LogStatus.PASS,
							"Upon clicking 'View all' button page is redirected to " + (Baseclass.get_Url()) + " Page");
				} else {
					test.log(LogStatus.FAIL, "Upon clicking 'View all' button page is getting redirected to "
							+ (Baseclass.get_Url()) + " Page");
				}
				Baseclass.navigateBack();
			} else {
		...
		try {
			...
			if ((count_articles % 4) == 0) {
				...
				if (count_articles == count_PageNation) {
					test.log(LogStatus.PASS, "Number of articles in the home page are " + (count_articles * 4)
							+ " and Pagenations populated are " + count_PageNation);
				} else {
					test.log(LogStatus.FAIL, "Number of articles in the home page are " + (count_articles * 4)
							+ " and but the Pagenations populated are " + count_PageNation);
				}
			} else {
				int Card_articles = count_articles / 4;
				if ((Card_articles + 1) == count_PageNation) {
					test.log(LogStatus.PASS, "Number of articles in the home page are " + count_articles
							+ " and Pagenations populated are " + count_PageNation);
				} else {
					test.log(LogStatus.FAIL, "Number of articles in the home page are " + count_articles
							+ " and but the Pagenations populated are " + count_PageNation);
				}
			}
	...
	public static void Login_footer_section() {
		try {
			...
			// String Linkden = Baseclass.WaitElementVisible(driver,
			// By.xpath(elementProperties.getProperty("footerlinkedin"))).getAttribute("href");
			// Baseclass.navigateUrl(Linkden);
			// Baseclass.explicitlyWait(Baseclass.timeout);
			String link = Baseclass
					.WaitElementVisible(driver, By.xpath(elementProperties.getProperty("footerlinkedin")))
					.getAttribute("href");
		...
		try {
			...
			try {
				...
				for (i = 1; i <= Card_Count; i++) {
					String Card_Title = driver
							.findElement(By.xpath(
									"//*[@id=\"item-list\"]/div/div/div/div[" + i + "]/article/div/div[2]/a/p[1]"))
							.getCssValue("font-family");
					String Card_Title_colour = driver
							.findElement(By.xpath(
									"//*[@id=\"item-list\"]/div/div/div/div[" + i + "]/article/div/div[2]/a/p[1]"))
							.getCssValue("color");
					String Card_Sub_Title = driver
							.findElement(By.xpath(
									"//*[@id=\"item-list\"]/div/div/div/div[" + i + "]/article/div/div[2]/a/span"))
							.getCssValue("font-family");
					String Card_Sub_Title_colour = driver
							.findElement(By.xpath(
									"//*[@id=\"item-list\"]/div/div/div/div[" + i + "]/article/div/div[2]/a/span"))
							.getCssValue("color");
					String Card_Time = driver
							.findElement(By.xpath(
									"//*[@id=\"item-list\"]/div/div/div/div[" + i + "]/article/div/div[2]/a/p[2]"))
							.getCssValue("font-family");
					String Card_Time_Color = driver
							.findElement(By.xpath(
									"//*[@id=\"item-list\"]/div/div/div/div[" + i + "]/article/div/div[2]/a/p[2]"))
							.getCssValue("color");

					System.out.println("Card_Title :" + Card_Title + " Card_Title :" + Card_Title_colour
							+ " Card_Sub_Title :" + Card_Sub_Title + " Card_Sub_Title_colour :" + Card_Sub_Title_colour
							+ " Card_Time :" + Card_Time + " Card_Time_Color :" + Card_Time_Color);

					if ((Card_Title.equalsIgnoreCase(elementProperties.getProperty("Card_Title_Font"))
							&& (Card_Title_colour.equalsIgnoreCase("rgba(68, 68, 68, 1)")))) {
						test.log(LogStatus.PASS,
								"Font and Color of main title in Events Card " + i + " is populating fine");
					} else {
						test.log(LogStatus.FAIL,
								"Font and Color of main title in Events Card " + i + " is not populating fine");
					}

					if ((Card_Sub_Title.equalsIgnoreCase(elementProperties.getProperty("Card_Sub_Title_Font"))
							&& (Card_Title_colour.equalsIgnoreCase("rgba(68, 68, 68, 1)")))) {
						test.log(LogStatus.PASS,
								"Font and Color of Sub title in Events Card " + i + " is populating fine");
					} else {
						test.log(LogStatus.FAIL,
								"Font and Color of Sub title in Events Card " + i + " is not populating fine");
					}

					if ((Card_Time.equalsIgnoreCase(elementProperties.getProperty("Card_Title_Font"))
							&& (Card_Time_Color.equalsIgnoreCase("rgba(117, 117, 117, 1)")))) {
						test.log(LogStatus.PASS,
								"Font and Color of Time Text in Events Card " + i + " is populating fine");
					} else {
						test.log(LogStatus.FAIL,
								"Font and Color of Time Text in Events Card " + i + " is not populating fine");
					}
				}
			} catch (TimeoutException | NoSuchElementException e) {
