...
@PCC_Footer&MenuOptions.PREMIER
...
|browser	|
|chrome		|
@PCC_Article_Validations.PREMIER
...
@PCC_Verify_individual_Article_page.PREMIER
...
@PCC_Verify_All_Article_design_and_Pagenation.PREMIER
Scenario Outline: Verify Individual Article Page
Given Open site in "<browser>"  
Then navigate to the site
Then verify the home page title
...
@PCC_Verify_All_Article_Pagenation.PREMIER
Scenario Outline: Verify Individual Article Page
Given Open site in "<browser>"  
Then navigate to the site
Then verify the home page title
...
@PCC_verify_Subscribe_Article_page.PREMIER
...
@PCC_verify_Subscribe_Article_page_linkdn_login.PREMIER
...
@PCC_Events_Validations.PREMIER
...
@PCC_Validate_Subscribe_Preference.PREMIER
...
@PCC_Search_Validations.PREMIER
...
@PCC_Home_Page_Articles.PREMIER
...
@subscribe.PREMIER
@Subscribe_before_Login.PREMIER
Scenario Outline: verify functionality of linkdin without login with linkdin from article page
	...
	Examples: 
		|browser	|
		|chrome		|
@subscribe_After_Logging.PREMIER
Scenario Outline: verify functionality of login with linkdin from article page
	...
	Examples: 
		|browser	|
		|chrome		|
@Account_Preference_Link.PREMIER
Scenario Outline: Verify the Preference link(TC ID-64)
	...
	Examples: 
		|browser	|
		|chrome		|
@Business_Preferences_Saving.PREMIER
...
|browser	|
|chrome		|
@clear_All_Button_All_Article_Page.PREMIER
...
Examples: 
		|browser	|
		|chrome		|		
@clear_All_Button_On_Pop_Up.PREMIER
...
Examples: 
		|browser	|
		|chrome		|
@Dropdowns_Selection.PREMIER
@Business_location_Saving.PREMIER
...
@Business_Turn_Over_Saving.PREMIER		
Scenario Outline: Verify the user is able to select an option
Given Open site in "<browser>"  
Then navigate to the site
Then verify the home page title
...
Examples: 
		|browser	|
		|chrome		|
@Preference_Page_Validations.PREMIER
...
Examples: 
		|browser	|
		|chrome		|
@Select_All_Filter_Pop_Up.PREMIER  
